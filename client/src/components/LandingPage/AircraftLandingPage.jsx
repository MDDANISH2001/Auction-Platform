    ...
    <React.Fragment>
      ...
      <>
        ...
        >
          ...
          >
            Aircraft Cabin Auction Platform
          </Typography>
          <Typography 
            sx={{
              mt: 2,
          ...
          >
            Join us for an exciting auction of aircraft cabin components,
            including seats, galleys, and overhead bins from a variety of
            aircraft types. This is a rare chance to acquire genuine aircraft
            parts for home theaters, aviation-themed spaces, and more.
          </Typography>
          ...
          <Typography sx={{ marginTop: "calc(10% + 60px)" }}>
            Project is made by MD DANISH as an assignment to show in Ziegler
            Aerospace.
          </Typography>
        </Box>
      </>
...
export default AircraftLandingPage;
